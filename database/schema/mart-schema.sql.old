...
CREATE TABLE `mart_entries` (
  ...
  KEY `mart_entries_mart_questionnaire_id_participant_id_index` (`schedule_id`,`participant_id`),
  KEY `mart_entries_questionnaire_id_index` (`questionnaire_id`),
  CONSTRAINT `mart_entries_mart_questionnaire_id_foreign` FOREIGN KEY (`schedule_id`) REFERENCES `mart_schedules` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mart_questions` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`uuid`),
  KEY `mart_questions_mart_questionnaire_id_foreign` (`schedule_id`),
  KEY `idx_ios_data_collection` (`is_ios_data_collection`),
  KEY `idx_android_data_collection` (`is_android_data_collection`),
  CONSTRAINT `mart_questions_mart_questionnaire_id_foreign` FOREIGN KEY (`schedule_id`) REFERENCES `mart_schedules` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mart_schedules` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `mart_questionnaires_mart_project_id_questionnaire_id_unique` (`mart_project_id`,`questionnaire_id`),
  KEY `mart_questionnaires_type_index` (`type`),
  CONSTRAINT `mart_questionnaires_mart_project_id_foreign` FOREIGN KEY (`mart_project_id`) REFERENCES `mart_projects` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (3,'2025_10_01_000001_create_mart_base_schema',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2025_11_10_151633_add_data_collection_flags_to_mart_questions',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2025_11_10_151648_add_success_page_flag_to_mart_pages',4);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2025_11_18_142547_add_data_collection_uniqueness_constraints_fixed',5);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2025_11_19_113826_add_data_collection_uniqueness_constraints_fixed',6);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2025_11_10_154056_add_introductory_text_to_mart_schedules',5);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2025_11_10_151706_add_data_collection_uniqueness_constraints',5);
