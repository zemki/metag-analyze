...
CREATE TABLE `cases` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `file_token` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `entries` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `begin` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `end` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  CONSTRAINT `entries_media_id_foreign` FOREIGN KEY (`media_id`) REFERENCES `media` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mart_questionnaire_schedules` (
  ...
  `notification_text` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `daily_interval_duration` int DEFAULT NULL,
  `min_break_between` int DEFAULT NULL,
  `max_daily_submits` int DEFAULT NULL,
  `daily_start_time` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `daily_end_time` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `quest_available_at` enum('startOfInterval','randomTimeWithinInterval') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `projects` (
  ...
  `inputs` text COLLATE utf8mb4_unicode_ci,
  `entity_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'entity',
...
CREATE TABLE `users` (
  ...
  `last_login_date` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  ...
  `linguaprojects` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `users_profiles` (
  ...
  `phonenumber1` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phonenumber2` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `workaddress` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
