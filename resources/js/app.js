...
window.app = new Vue(
    {
      ...
      mounted()
      {
        ...
        let replaceUndefinedOrNull = function(
            key,
            value)
          {
          if (value ===
      ...
      watch: {
        ...
        'newcase.duration.startdate': function(
            newVal,
            OldVal)
          {
          if (!_.isEmpty(
        ...
        'newuser.case.duration.input': function(
            newVal,
            OldVal)
          {
        ...
        'newuser.case.duration.selectedUnit': function(
            newVal,
            OldVal)
          {
          if (!_.isEmpty(
