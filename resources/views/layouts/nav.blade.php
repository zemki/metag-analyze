    ...
    <div class="z-50 w-1/2 mx-auto overflow-y-auto bg-white rounded shadow-lg modal-container md:max-w-md">
        ...
        <div class="p-4 m-2 bg-green-100 rounded-md" v-if="newemail.message">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-green-800">@{{trans('Email Changed')}}
                    </h3>
        ...
        <div class="px-2 mx-auto max-w-7xl sm:px-4 lg:px-8">
            <div class="relative flex items-center justify-between h-16">
                ...
                Auth::user()->email }}</span>
                  ...
                  Profile')}}</a>
                                @endif
                                <a title="Change Email" class="flex w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem"
                                                    tabindex="-1" id="user-menu-item-0" @click="toggleModalChangeEmail()">{{'Change your email'}}</a>
