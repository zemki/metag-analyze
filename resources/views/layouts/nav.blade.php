<!-- Email Change Modal will be handled by Vue component -->
<!-- END Modal-->
                        ...
                        <div class="relative z-50 flex-shrink-0 ml-4">
                            ...
                            <div id="dropdownLogout"
                                ...
                                <button title="Change Email"
                                        ...
                                        tabindex="-1" 
                                        id="user-menu-item-0"
                                        @click="showEmailChangeModal = true"
                                        type="button">
                                    {{'Change your email'}}
                                </button>
...
<!-- Email Change Modal -->
<email-change-modal v-model:visible="showEmailChangeModal"></email-change-modal>
