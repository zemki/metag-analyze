                        ...
                        <div class="flex justify-center mb-4">
                            ...
                            <div class="md:w-1/2">
                                <input id="email" disabled type="email" value="{{$user->email}}"
                                    ...
                                    focus:outline-hidden focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm disabled:opacity-50 {{ $errors->has('email') ? ' bg-red-dark' : '' }}" name="email"
                        ...
                        <div class="flex justify-center mb-4">
                            ...
                            <div class="md:w-1/2">
                                <input id="password" type="password"
                                    class="relative block w-full px-3 py-2 text-gray-900 placeholder-gray-500 border border-gray-300 rounded-none appearance-none
                                    focus:outline-hidden focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm {{ $errors->has('password') ? ' bg-red-dark' : '' }}" name="password"
