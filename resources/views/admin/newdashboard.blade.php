...
@section('content')
                ...
                <div class="flex relative inline-block float-right">
                    ...
                    <div class="relative text-sm text-gray-100">
                        <button id="userButton" class="flex items-center focus:outline-none mr-3">
                            ...
                            <svg class="pl-2 mb-2 font-medium leading-tight text-3xl fill-current text-gray-100" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 129 129" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 129 129"><g><path d="m121.3,34.6c-1.6-1.6-4.2-1.6-5.8,0l-51,51.1-51.1-51.1c-1.6-1.6-4.2-1.6-5.8,0-1.6,1.6-1.6,4.2 0,5.8l53.9,53.9c0.8,0.8 1.8,1.2 2.9,1.2 1,0 2.1-0.4 2.9-1.2l53.9-53.9c1.7-1.6 1.7-4.2 0.1-5.8z"/></g></svg>
                        </button>
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-gray-900 z-20" id="nav-content">
                ...
                <div class="relative pull-right pl-4 pr-4 md:pr-0">
                    ...
                    <div class="absolute search-icon" style="top: 0.375rem;left: 1.75rem;">
                        <svg class="fill-current pointer-events-none text-gray-500 w-4 mb-2 font-medium leading-tight text-xl" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
    ...
    <!--Container-->
    <div class="container mx-auto mx-auto mx-auto w-full mx-auto pt-20">
    ...
    <footer class="bg-gray-900 border-t border-gray-400 shadow">
        <div class="container mx-auto mx-auto mx-auto max-w-md mx-auto flex py-8">
