			...
			<form method="POST" action="{{route('users')}}" class="" style="padding-top: 40px" id="adduser" autocomplete="off">
				...
				<div class="field">
					<div class="control">
						...
						<div class="columns">
						<div class="column">
							<input type="text" class="input" name="email" list="email" autocomplete="off" v-model="newuser.email">
							<p v-html="newuser.emailexistmessage" class="notification is-warning is-small mt-3" v-if="newuser.emailexistmessage.length > 0 && newuser.email.length > 3"></p>
						</div>
							<div class="column">
								<div class="select">
				...
				<div class="field">
					...
					<div class="control">
						...
						<p v-html="newuser.case.caseexistmessage" class="notification is-warning is-small mt-3" v-if="newuser.case.caseexistmessage.length > 0"></p>
				...
				<div class="field">
					...
					<div class="columns">
						...
						<div class="column" v-show="newuser.case.duration.message != ''" v-html="'Estimated end (if the user log-in today): ' +newuser.case.duration.message">
				...
				<div class="field">
					<div class="control">
						<button class="button is-link" :disabled="newuser.email.length < 4 || newuser.case.caseexist">Create User</button>
					</div>
				</div>
