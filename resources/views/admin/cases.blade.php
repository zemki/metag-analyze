...
@section('content')
    ...
    @foreach($projects as $project)
        ...
        <h1 class="break-words text-xl font-bold mt-2">Created by: {{$project->created_by()->email}}</h1>
        ...
        <b-tabs class="block w-full" expanded>
            ...
            <b-tab-item label="Inputs">
                ...
                <b-tab-item label="Invites">
                    <project-invites :invitedlist="{{$project->invited()->get()}}" :project="{{$project->id}}"></project-invites>
                </b-tab-item>

        </b-tabs>
        <hr class="border border-solid border-black my-4 w-full">
    @endforeach
@endsection
