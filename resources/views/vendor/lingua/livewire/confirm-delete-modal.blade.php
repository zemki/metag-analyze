            ...
            <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
                ...
                <div class="modal-content py-4 text-left px-6">
                    ...
                    <div class="flex justify-end pt-2">
                        ...
                        @if($entityToDelete === "merge translations")
                            <button class="inline-flex items-center justify-center p-2 text-gray-400 rounded-md hover:text-white hover:bg-gray-700 focus:outline-hidden focus:ring-2 focus:ring-inset focus:ring-white" wire:click="delete()">Merge</button>

                        @else
                            <button class="inline-flex items-center justify-center p-2 text-red-400 rounded-md hover:text-white hover:bg-red-700 focus:outline-hidden focus:ring-2 focus:ring-inset focus:ring-white" wire:click="delete()">Delete</button>
